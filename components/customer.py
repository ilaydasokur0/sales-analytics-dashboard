...
def build_product_detail_table(current_df, previous_df):
...
def render_customer_city_product_table(current_df, previous_df):
    st.header("Ürün Performansı")
    table = build_product_detail_table(current_df, previous_df)
